...
export const mockLeads = [
  ...
  },
  {
    ...
    status: "contacted",
    source: "WhatsApp",
    automationType: "AI משולב אישי",
    questionnaire: "טופס צור קשר",
    partner: "יעל לוי",
    templateName: "תבנית AI עם נגיעה אישית",
    commission: {
      type: "fixed",
      value: 200,
      frequency: "per_lead",
  ...
  },
  {
    ...
    status: "new",
    source: "LinkedIn",
    automationType: "משוב אישי",
    questionnaire: "טופס צור קשר",
    partner: "",
    templateName: "תבנית תגובה אישית",
    questionnaireAnswers: {
      "שם מלא": "יוסי אברהם",
  ...
  },
  {
    ...
    status: "open",
    source: "Facebook",
    automationType: "סטנדרט",
    questionnaire: "טופס צור קשר",
    partner: "רון אבני",
    templateName: "תבנית סטנדרטית",
    commission: {
      type: "percentage",
      value: 12,
      frequency: "monthly",
  ...
  },
  {
    ...
    questionnaire: "טופס צור קשר",
    partner: "מיכל גרין",
    templateName: "תבנית תזכורת חכמה",
    commission: {
      type: "hybrid",
