          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="עריכת דין, פיננסים וביטוח">עריכת דין, פיננסים וביטוח</SelectItem>
                    <SelectItem value="נדל״ן, בנייה ועיצוב">נדל״ן, בנייה ועיצוב</SelectItem>
                    <SelectItem value="אימון, טיפול והתפתחות אישית">אימון, טיפול והתפתחות אישית</SelectItem>
                    <SelectItem value="יופי, בריאות ואסתטיקה">יופי, בריאות ואסתטיקה</SelectItem>
                    <SelectItem value="מסעדנות, אוכל ואירועים">מסעדנות, אוכל ואירועים</SelectItem>
                    <SelectItem value="טכנולוגיה, הדרכה ועסקים דיגיטליים">טכנולוגיה, הדרכה ועסקים דיגיטליים</SelectItem>
                    <SelectItem value="תיירות, תחבורה ושירותים">תיירות, תחבורה ושירותים</SelectItem>
                    <SelectItem value="עמותות וקהילה">עמותות וקהילה</SelectItem>
